...
extension SavedPaymentMethodCollectionView {
    ...
    class PaymentOptionCell: UICollectionViewCell, EventHandler {
        ...
        let roundedRectangleSize = CGSize(width: 88, height: 56)
        ...
        override init(frame: CGRect) {
            ...
            NSLayoutConstraint.activate([
                ...
                paymentMethodLogo.widthAnchor.constraint(equalToConstant: 42),
                paymentMethodLogo.heightAnchor.constraint(equalToConstant: 26),
