...
class ChoosePaymentOptionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        view.directionalLayoutMargins = NSDirectionalEdgeInsets(top: 0, leading: padding, bottom: padding + 18, trailing: padding)
                ...
                case let .success(newPaymentMethod):
                    ...
                    DispatchQueue.main.asyncAfter(deadline: .now() + 1) {
                        ...
                        self.addPaymentMethodViewController = AddPaymentMethodViewController(
                            ...
                            billingAddressCollection: self.configuration.billingAddressCollection,
