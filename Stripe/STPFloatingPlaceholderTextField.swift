...
class STPFloatingPlaceholderTextField: UITextField {
    ...
    func layoutPlaceholder(animated: Bool) {
        ...
        var placeholderColor: UIColor = STPFloatingPlaceholderTextField.LayoutConstants.defaultPlaceholderColor
        ...
        if minimized {
            ...
            placeholderColor = STPFloatingPlaceholderTextField.LayoutConstants.floatingPlaceholderColor
        }
