...
class PaymentSheetTestPlayground: UIViewController {
    ...
    var configuration: PaymentSheet.Configuration {
        ...
        configuration.billingAddressCollection = billingModeSelector.selectedSegmentIndex == 0 ? .automatic : .required
...
extension PaymentSheetTestPlayground {
    ...
    func load() {
        ...
        let url = URL(string: "https://stripe-mobile-payment-sheet.glitch.me/checkout")!
